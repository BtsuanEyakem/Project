window.onload = function () {
    ...
    let playlist = [];
    let currentTrack = 0;
    let playbackMode = 0; // 0: Repeat Playlist, 1: Repeat Current Song, 2: Shuffle
    ...
    function getNextPrevSong(mode) {
        if (playbackMode == 0) { // Repeat Playlist
            if (mode === 'prev') {
        ...
        if (playbackMode == 1) { // Repeat Current Song
            return currentTrack;
        } else if (playbackMode == 2) { // Shuffle
